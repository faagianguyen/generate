...
class A1CWeekChart extends StatefulWidget {
  ...
  @override
  State<A1CWeekChart> createState() => _A1CWeekChartState();
}

class _A1CWeekChartState extends State<A1CWeekChart> {
  ...
  @override
  void didUpdateWidget(covariant A1CWeekChart oldWidget) {
                    ...
                    Expanded(
                      child: PageView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          // Tìm ngày đầu tuần (Monday) cho tuần này
                          DateTime? weekStart;
                          if (weekData.isNotEmpty) {
                            final now = DateTime.now();
                            final today =
                                now.subtract(Duration(days: now.weekday - 1));
                            weekStart = today.subtract(Duration(
                                    days: widget.weeksData.length - 1 - index) *
                                7);
                          }
